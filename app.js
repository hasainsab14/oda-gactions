...
module.exports = function() { 
  ...
  const NO_INPUTS = [
    ...
    'Se sei ancora lì, parla di nuovo.',
    'Possiamo terminare qui. A presto.'
  ];
  ...
  var metadata = {
    ...
    channelSecretKey: 'LDtlluEFQW2WWFR6fD6sjr0zoSVz4GHJ',
    channelUrl: 'https://AMCE0587644614bmxp-gse00015244.mobile.ocp.oraclecloud.com:443/connectors/v1/tenants/idcs-3002129feb3f4ed09af11a9a3375e791/listeners/webhook/channels/EC7CF764-A283-4352-88BA-F74F09EC3EF9'
  };
  ...
  this.init= function (config) {
    ...
    app.post('/romamobilitaBotWebhook/messages', bodyParser.json({
      verify: webhookUtil.bodyParserRawMessageVerify
    }), function (req, res) {
      logger.info('==> /romamobilitaBotWebhook')
    ...
    app.post('/', function (request, response) {
      ...
      function mainIntent (gapp) {
        console.log('Inizio sessione con Google Assistant. Chiamo mainIntent()');
    ...
    app.locals.endpoints.push({
      name: 'webhook',
      method: 'POST',
      endpoint: '/romamobilitaBotWebhook/messages'
    });
    app.locals.endpoints.push({
      name: 'gaction',
      method: 'POST',
